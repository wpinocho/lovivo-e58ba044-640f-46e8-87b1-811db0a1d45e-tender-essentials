    ...
    <div className={`bg-foreground text-background py-16 ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="mt-4 text-background/70 leading-relaxed">
              Supporting new parents with carefully curated baby and postpartum essentials
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-background/20 text-center text-background/70">
          <p>&copy; 2025 Baby Essentials. All rights reserved. Made with love for new parents.</p>
        </div>
      </div>
    </div>
  )
